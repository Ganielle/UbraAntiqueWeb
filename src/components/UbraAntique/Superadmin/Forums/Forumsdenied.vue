  ...
  >
    ...
    <div v-else class="block w-full overflow-x-auto">
      ...
      <table class="items-center w-full bg-transparent border-collapse">
        ...
        <tbody>
          <tr v-for="items in forums" :key="items._id">
            <td
            ...
            <td
              class="border-t-0 px-6 text-center align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4"
            >
              {{ truncatedDescription(items.content) }}
            </td>
            <td
              class="border-t-0 px-6 text-center align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4"
            >
              {{ items.owner.firstname.toUpperCase() }} {{ items.owner.lastname.toUpperCase() }}
            </td>
            <td
              class="border-t-0 px-6 text-center align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4"
            >
