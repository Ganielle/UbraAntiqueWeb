          ...
          <div class="flex-auto px-4 lg:px-10 py-10 pt-5">
            ...
            <form>
              ...
              <div class="relative flex w-full flex-wrap items-stretch mb-3">
                ...
                v-model="user.password" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-sm border border-blueGray-300 outline-none focus:outline-none focus:shadow-outline w-full pr-10"/>
