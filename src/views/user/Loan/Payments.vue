<template>
    <div>
        ...
        <br/><br/>
        <PaymentsTable :requestitems="historylist" @pay-loan="ToggleRequestModal"/>
        ...
        <div>
            <vue-final-modal v-model="requestmodal" classes="modal-container"  :clickToClose="false" :escToClose="false" content-class="modal-content">
                ...
                <span class="modal__title">Loan Payment Form</span>
                <br/>
                <div class="modal__content">
                    ...
                    <p class="mt-3">Loan Payment Amount:</p>
...
import PaymentsTable from '@/components/Subastanauan/Dashboard/User/Loanpaymenttable.vue';
...
export default{
    ...
    methods: {
        ...
        async RequestCashin(){
            ...
            formData.append("loanid", this.itemid)
            ...
            const response = await fetch(`${process.env.VUE_APP_API_URL}/loan/payloan`, {
                method: 'POST',
                headers: {
        ...
        async CashinHistory(){
            ...
            const response = await fetch(`${process.env.VUE_APP_API_URL}/loan/loanpayments?page=${this.historypagination.page}&limit=${this.historypagination.limit}`, {
                method: 'GET',
                headers: {
